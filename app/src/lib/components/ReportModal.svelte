...
<!-- Se puede descartar: reportar es opcional y cerrar sin hacerlo es una
	respuesta válida. Las safe areas ahora vienen del componente — esta copia
	las había perdido, y los botones caían en la franja del indicador. -->
<BottomSheet {onclose}>
