	...
	<div class="flex-1 overflow-y-auto px-5 pb-6">
		...
		{#if !editing}
			...
			<section class="mt-6">
				...
				<div class="space-y-2">
					<a href={legalUrl('privacy')} target="_blank" rel="noopener" class="flex items-center justify-between rounded-card bg-white p-4 shadow-card active:scale-[0.98]">
						<span class="text-sm font-medium text-ink">{t('legal.privacy')}</span>
						<svg class="h-4 w-4 text-ink-muted" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="9 18 15 12 9 6"/></svg>
					</a>
					<a href={legalUrl('terms')} target="_blank" rel="noopener" class="flex items-center justify-between rounded-card bg-white p-4 shadow-card active:scale-[0.98]">
						<span class="text-sm font-medium text-ink">{t('legal.terms')}</span>
						<svg class="h-4 w-4 text-ink-muted" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="9 18 15 12 9 6"/></svg>
					</a>
					<a href={legalUrl('community')} target="_blank" rel="noopener" class="flex items-center justify-between rounded-card bg-white p-4 shadow-card active:scale-[0.98]">
						<span class="text-sm font-medium text-ink">{t('legal.community')}</span>
						<svg class="h-4 w-4 text-ink-muted" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="9 18 15 12 9 6"/></svg>
					</a>
					<a href={legalUrl('cookies')} target="_blank" rel="noopener" class="flex items-center justify-between rounded-card bg-white p-4 shadow-card active:scale-[0.98]">
						<span class="text-sm font-medium text-ink">{t('legal.cookies')}</span>
						<svg class="h-4 w-4 text-ink-muted" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="9 18 15 12 9 6"/></svg>
					</a>
					<a href={legalUrl('contact')} target="_blank" rel="noopener" class="flex items-center justify-between rounded-card bg-white p-4 shadow-card active:scale-[0.98]">
